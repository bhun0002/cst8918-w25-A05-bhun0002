...
# Fix: Add the required 'features {}' block inside the azurerm provider
provider "azurerm" {
  features {} # This is required for the Azure provider to work
}
...
resource "azurerm_linux_virtual_machine" "webserver" {
  ...
  admin_ssh_key {
    ...
    public_key = file("/home/bhun0002/.ssh/id_rsa.pub")
  }
